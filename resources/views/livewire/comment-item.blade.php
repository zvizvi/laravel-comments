                                    ...
                                    @if ($model->canEditComment($comment))
                                        <li
                                            ...
                                            @class([
                                                ...
                                                "flex items-center space-x-2 rtl:space-x-reverse rounded p-2 dark:hover:!bg-slate-900"
                                            ])
                                        >
                        ...
                        >
                            <x-comments::link
                                ...
                                @class([
                                    ...
                                    "!rounded-[1000px] hover:rounded-[1000px] space-x-2 rtl:space-x-reverse" => Helpers::isModernTheme(),
                                ])
                                @style([
